...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FeatureBench or Crane Digital Platforms.
...
- __Website__ refers to FeatureBench, accessible from [https://featurebench.com](https://featurebench.com)
...
Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers, activity on pages, and other diagnostic data.
...
- __Fingerprints.__ A fingerprint is a unique fingerprint of your browser and device, able to persist incognito windows and cookie clears.
...
- __With Your Instructor/Institution__: In the event of plagarism your personal information may be shared with your instructor or institution
...
You may update, amend, or delete Your information at any time by contacting Us to request access to, provide, correct, or delete any personal information that You have provided to Us.
...
Your Personal Data may be disclosed to an instructor or institution in the event of a breach of academic integrity or other challenges.
...
- By email: support@featurebench.com